...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=[{'label': 'All Sites', 'value': 'ALL'},{'label': 'site1', 'value': 'site1'},{'label': 'site0', 'value': 'site0'}], value='ALL', placeholder='Select a Launch Site here', searchable=True),
                                html.Br(),
