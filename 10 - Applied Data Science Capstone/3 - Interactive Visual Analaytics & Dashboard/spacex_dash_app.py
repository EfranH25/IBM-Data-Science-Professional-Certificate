...
spacex_df = pd.read_csv(r"F:\GitHub\IBM-Data-Science-Professional-Certificate\10 - Applied Data Science Capstone\3 - Interactive Visual Analaytics & Dashboard\spacex_launch_dash.csv")
